...
// list, minus `.deepmicode` — the indexer shouldn't embed session logs / cache, but
...
export function registerFilesystemTools(
  ...
  /** Same idea as withSubdirMemory but for list_directory — includes the listed dir's own DEEPMICODE.md, not just ancestors. */

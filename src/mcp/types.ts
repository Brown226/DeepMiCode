...
export interface McpToolSchema {
  /** JSON Schema — compatible with DeepMiCode's tools.ts JSONSchema shape. */
  type?: string;
...
/** MCP result content is an array of typed blocks. DeepMiCode consumes only text for now — image blocks get stringified with a placeholder. */

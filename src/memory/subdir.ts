/** Module-scoped memory files (#1033). Walks from a file's dir up to rootDir, collecting DEEPMICODE.md (or AGENTS.md / AGENT.md) found along the way. The root's memory is excluded — it's already in the system prompt via applyProjectMemory. */

...
function AppInner({
  ...
  // they don't fight the picker for visual attention. Tighter than `modalOpen` �?  // doesn't include model/theme/copy-mode pickers that overlay without owning
  // the bottom rows.
  ...
  useKeystroke((ev) => {
    ...
    // Picker arrow nav lives on the PromptInput �?historyHandoff �?    // handleHistoryPrev/Next path (which checks pickers before recall).

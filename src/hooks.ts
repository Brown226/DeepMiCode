...
/** Shape of `<scope>/.deepmicode/settings.json` — only `hooks` for now. */
...
export const HOOK_SETTINGS_DIRNAME = ".deepmicode";

/** Where the global settings.json lives. Equivalent to `~/.deepmicode/settings.json`. */

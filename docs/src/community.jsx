...
function useGithubStats() {
  ...
  React.useEffect(() => {
    let cancelled = false;
    fetch("https://api.github.com/repos/esengine/DeepSeek-deepmicode")
      ...
      .catch(() => {});
    fetch("https://api.github.com/repos/esengine/DeepSeek-deepmicode/contributors?per_page=24")
      .then(r => r.ok ? r.json() : null)
      .then(j => {
      ...
      <div className="community-grid">
        <div className="star-card">
          ...
          <div style={{display:"flex", gap:10, marginTop:18, flexWrap:"wrap"}}>
            <a className="btn btn-primary btn-sm" href="https://github.com/esengine/DeepSeek-deepmicode" target="_blank" rel="noreferrer">
            ...
            <a className="btn btn-ghost btn-sm" href="https://github.com/esengine/DeepSeek-deepmicode/discussions" target="_blank" rel="noreferrer">
        ...
        <div className="contrib-grid">
          ...
          <div className="contrib-wall">
            ...
            {contributors.length > 0 && (
              <a
                href="https://github.com/esengine/DeepSeek-deepmicode/graphs/contributors"
                target="_blank"
                rel="noreferrer"
                className="contrib-avatar"
          ...
          <p style={{color:"var(--cream-mute)", fontSize:12.5, marginTop:18, marginBottom:0, lineHeight:1.6}}>
            {t({
              zh: <>想成为下一个？阅读 <a href="https://github.com/esengine/DeepSeek-deepmicode/blob/main/CONTRIBUTING.md" target="_blank" rel="noreferrer" style={{color:"var(--accent)", textDecoration:"none"}}>CONTRIBUTING.md</a> 并领取一个 <span className="kbd">good first issue</span>。</>,
              en: <>Want to be next? Read <a href="https://github.com/esengine/DeepSeek-deepmicode/blob/main/CONTRIBUTING.md" target="_blank" rel="noreferrer" style={{color:"var(--accent)", textDecoration:"none"}}>CONTRIBUTING.md</a> and pick up a <span className="kbd">good first issue</span>.</>,
            }, lang)}
          </p>
        </div>
      </div>

...
const GH_REPO = "esengine/DeepSeek-deepmicode";
  ...
  return [
    {
      id: "mac",
      label: "macOS",
      file: `deepmicode_${version}_universal.dmg`,
      size: "52 MB",
    ...
    },
    {
      id: "win",
      label: "Windows",
      file: `deepmicode_${version}_x64-setup.exe`,
      size: "30 MB",
    ...
    },
    {
      id: "linux",
      label: "Linux",
      file: `deepmicode_${version}_amd64.AppImage`,
      size: "128 MB",

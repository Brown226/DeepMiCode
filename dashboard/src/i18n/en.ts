export const en = {
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside deepmicode code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside deepmicode code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in deepmicode chat / code / run and refresh.",
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active deepmicode code session — standalone deepmicode dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart deepmicode code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when deepmicode code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart deepmicode code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "DeepMiCode tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart deepmicode code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `deepmicode code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.deepmicode/config.json. Restart `deepmicode code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
    ...
    pickDesc: "Project DEEPMICODE.md is committable; global notes live in ~/.deepmicode/memory/.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from deepmicode code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with DeepMiCode; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run deepmicode index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "DeepMiCode doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.deepmicode/config.json — do not share that file.",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. DeepMiCode will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",

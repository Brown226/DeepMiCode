export const en = {
  ...
  about: {
    sidebarLabel: "About",
    tagline: "DeepSeek + Mimo AI coding agent",
    version: "Version",
    repo: "Repository",
  ...
  toast: {
    ...
    cleared: "UI cleared",
    aboutLine: "DeepMiCode v{version} · DeepSeek + Mimo AI agent",
  },
  composer: {
    busy: "DeepMiCode is thinking…",
    idle: "Ask something",
    send: "send",
    newline: "newline",
    commands: "commands",
  ...
  settings: {
    ...
    providersSection: "API Providers",
    providersSectionDesc: "Configure multiple AI model providers. Each provider can have its own API key and models.",
    providersEmpty: "No providers configured. The default DeepSeek/MiMo providers are used automatically.",
    ...
    providerNamePlaceholder: "My OpenAI",
    providerKind: "API Type",
    providerBaseUrl: "Base URL",
    providerApiKey: "API Key",
    providerModelsLabel: "Models",
    providerModelsPlaceholder: "gpt-4o, gpt-4o-mini, gpt-3.5-turbo",
    providerModelsHint: "Comma-separated model IDs",
    ...
    mimoApiKeyHint: "Separate key for Xiaomi MiMo models. Falls back to MIMO_API_KEY env var.",
    mimoApiKeyNotSet: "(not set)",
    mimoApiKeySave: "Save",
    ...
    apiKey: "API key",
    apiKeyHint: "DeepSeek or MiMo key — saved to ~/.deepmicode/config.json (0600).",
    ...
    mcpBridged: "· Bridged",
    mcpNotBridged:
      "· Current desktop session not bridged — restart deepmicode code (TUI) to take effect",
  ...
  app: {
    ...
    cmd: {
      ...
      status: "Show current model, flags, context, session",
      cost: "Show last turn cost / estimate next turn cost",
      context: "Show context-window breakdown",
      stats: "Cross-session cost dashboard",
      doctor: "Health check (API, config, hooks)",
      sessions: "List saved sessions",
      title: "Rename this session",
      budget: "Set session USD cap",
      mcp: "List MCP servers + tools",
      memory: "Show / manage pinned memory",
      init: "Generate DEEPMICODE.md for this project",
      undo: "Roll back the last applied edit",
      apply: "Commit pending edit blocks to disk",
      discard: "Drop pending edit blocks without writing",
      checkpoint: "Snapshot every file touched this session",
      restore: "Roll back files to a checkpoint",
      hooks: "List active hooks",
      permissions: "Show / edit shell allowlist",
      loop: "Auto-resubmit a prompt at intervals",
    ...
    connecting: "Connecting to DeepMiCode core…",
    startupFailedTitle: "DeepMiCode could not start",
  ...
  notifications: {
    approvalTitle: "DeepMiCode is waiting for approval",
    inputTitle: "DeepMiCode is waiting for input",
    planApprovalTitle: "DeepMiCode is waiting for plan approval",
    checkpointApprovalTitle: "DeepMiCode is waiting for checkpoint approval",
    revisionTitle: "DeepMiCode proposed a plan revision",
    commandBody: "Command: {command}",
    readBody: "Read: {path}",
    writeBody: "Write: {path}",
    turnCompleteTitle: "DeepMiCode task complete",
    turnCompleteBody: "The current task finished and is ready for review.",
  },
  scheduledTasks: {
    title: "Scheduled Tasks",
    desc: "Manage recurring or one-time scheduled tasks",
    allTasks: "All tasks",
    create: "New task",
    ...
    scheduleHint: "Standard 5-field cron: minute hour day month weekday",
    prompt: "Prompt",
    promptHint: "What the AI should do when the task runs",
    promptPlaceholder: "e.g. Review all commits from today and generate a summary",
    recurring: "Recurring",
    recurringHint: "Run repeatedly on schedule, or just once",
    yes: "Yes",
    no: "No",
    model: "Model",
    modelHint: "Optional: override the default model for this task",

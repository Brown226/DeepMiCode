...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    clearSearch: "清除搜索",
    noResults: "没有匹配的设置项",
    providersSection: "API 提供商",
    providersSectionDesc: "配置多个 AI 模型提供商，每个提供商可以有自己的 API Key 和模型列表。",
    providersEmpty: "暂无自定义提供商，默认使用 DeepSeek/MiMo。",
    providerDefault: "默认",
    providerModels: "个模型",
    ...
    providerModelsHint: "多个模型 ID 用逗号分隔",
    providerSave: "保存提供商",
    providerTest: "测试",
    providerTesting: "测试中…",
    ...
    mimoApiKey: "MiMo API 密钥",
    mimoApiKeyHint: "小米 MiMo 模型的独立密钥。留空则使用 MIMO_API_KEY 环境变量。",
    mimoApiKeyNotSet: "(未设置)",
    mimoApiKeySave: "保存",
    ...
    editorDefault: "(默认)",
    apiKey: "API key",
    apiKeyHint: "DeepSeek 或 MiMo key — 保存到 ~/.deepmicode/config.json (0600)。",
    apiKeyNotSet: "(未设置)",
    apiKeyCancel: "取消",
    apiKeySave: "保存",
    apiKeyShow: "显示",
    ...
    mcpBridged: "· 已桥接",
    mcpNotBridged: "· 当前桌面会话未桥接，重启 deepmicode code (TUI) 后生效",
    ...
    skillsEmpty:
      "没有可用技能。可在 ~/.deepmicode/skills/ 或 项目根/.deepmicode/skills/ 下创建 SKILL.md。",
    subagentModelFlash: "flash",
    subagentModelPro: "pro",
    subagentModelHint: "子代理默认模型",
    subagentModelSection: "子代理模型",
    subagentModelSectionDesc: "探索、研究、审查等子代理使用的默认模型，可在技能标签页中按技能单独覆盖。",
    memorySection: "长期记忆",
  ...
  app: {
    ...
    cmd: {
      ...
      retry: "截断并重发你的最后一条消息",
      btw: "旁路提问（不写入会话上下文）",
      status: "查看当前模型、标志、上下文、会话",
      cost: "查看上轮费用 / 估算下轮费用",
      context: "查看上下文窗口分解",
      stats: "跨会话费用仪表盘",
      doctor: "健康检查（API、配置、钩子）",
      sessions: "列出已保存会话",
      title: "重命名当前会话",
      budget: "设置会话费用上限",
      mcp: "列出 MCP 服务器 + 工具",
      memory: "查看 / 管理记忆",
      init: "为当前项目生成 DEEPMICODE.md",
      undo: "回滚最后一批编辑",
      apply: "提交待定编辑块到磁盘",
      discard: "丢弃待定编辑块",
      checkpoint: "快照本会话修改过的所有文件",
      restore: "恢复到检查点",
      hooks: "列出活跃钩子",
      permissions: "查看 / 编辑 Shell 白名单",
      loop: "定时重复提交提示",
      plans: "列出活跃 + 归档计划",
    },
    skill: {
    ...
    connecting: "正在连接 DeepMiCode 内核…",
    startupFailedTitle: "DeepMiCode 无法启动",
  ...
  scheduledTasks: {
    ...
    schedule: "调度规则 (cron)",
    scheduleHint: "标准5字段cron：分 时 日 月 周",
    prompt: "执行内容",
    promptHint: "任务触发时AI应该做什么",
    promptPlaceholder: "例如：审查今天所有提交并生成摘要",
    recurring: "重复执行",
    recurringHint: "按计划重复执行，还是只执行一次",
    yes: "是",
    no: "否",
    model: "模型",
    modelHint: "可选：为此任务指定模型",
    modelPlaceholder: "例如：deepseek-v4-flash",
    cancel: "取消",
    save: "保存",
  },
};
// Scheduled Tasks translations will be merged via spread

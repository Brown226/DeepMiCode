...
export const de: typeof en = {
  ...
  toast: {
    ...
    cleared: "UI geleert",
    aboutLine: "DeepMiCode v{version} · Cache-First-DeepSeek-Agent",
  },
  composer: {
    ...en.composer,
    busy: "DeepMiCode denkt nach...",
    idle: "Frag etwas",
    send: "senden",
    newline: "neue Zeile",
    commands: "Befehle",
  ...
  settings: {
    ...
    apiKeyHint: "DeepSeek-Schlüssel — gespeichert in ~/.deepmicode/config.json (0600).",
    ...
    mcpNotBridged:
      "· Aktuelle Desktop-Sitzung nicht verbunden — starte deepmicode code (TUI) neu, um wirksam zu werden",
    ...
    skillsEmpty:
      "Keine Skills verfügbar. Erstelle SKILL.md unter ~/.deepmicode/skills/ oder .deepmicode/skills/ in deinem Projekt-Root.",
  ...
  app: {
    ...
    connecting: "Verbinde mit DeepMiCode core...",
    startupFailedTitle: "DeepMiCode konnte nicht starten",
  ...
  notifications: {
    ...en.notifications,
    approvalTitle: "DeepMiCode wartet auf Genehmigung",
    inputTitle: "DeepMiCode wartet auf Eingabe",
    planApprovalTitle: "DeepMiCode wartet auf Plan-Genehmigung",
    checkpointApprovalTitle: "DeepMiCode wartet auf Checkpoint-Genehmigung",
    revisionTitle: "DeepMiCode hat eine Plan-Überarbeitung vorgeschlagen",
    commandBody: "Befehl: {command}",
    readBody: "Lesen: {path}",
    writeBody: "Schreiben: {path}",
    turnCompleteTitle: "DeepMiCode-Aufgabe abgeschlossen",

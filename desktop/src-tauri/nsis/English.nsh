...
LangString appRunning ${LANG_ENGLISH} "DeepMiCode is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "DeepMiCode is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill DeepMiCode. Please close it first then try again"

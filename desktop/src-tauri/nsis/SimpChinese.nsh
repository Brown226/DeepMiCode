...
LangString appRunning ${LANG_SIMPCHINESE} "DeepMiCode 正在运行！请先关闭它，然后重试。"
LangString appRunningOkKill ${LANG_SIMPCHINESE} "DeepMiCode 正在运行！$\n单击「确定」结束它"
...
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 DeepMiCode。请先关闭它然后重试。"
